...
public abstract class AbstractSTSingleGeometryDescriptor1 extends AbstractScalarFunctionDynamicDescriptor {

    abstract protected Object evaluateOGCGeometry(byte[] bytes, int offset) throws HyracksDataException;
    ...
    private class AbstractSTSingleGeometryEvaluator implements IScalarEvaluator {
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            try {
                ...
                Object finalResult = evaluateOGCGeometry(bytes0, offset0 + 6);
                if (finalResult == null) {
